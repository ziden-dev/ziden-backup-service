...
async function testUploadDataEncrypt() {
    ...
    const uploadPrivateResponse = await axios({
        method: "post",
        baseURL: baseUrl,
        url: urlPrivateEncrypt + "?type=ZIDEN",
        data: {
            "holderId": holderId,
...
async function testDecode() {
    ...
    const x = await fetch(baseUrl + urlEncrypt + "?" + "holderId=" + holderId + "&issuerId=" + issuerId + "&claimId=" + claimId + "&type=ZIDEN", {
        method: 'GET',
        headers: {
